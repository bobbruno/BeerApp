...
beerParser.parseRatings(1, 1, 1, 1, 1, 'http://www.ratebeer.com/beer/toppling-goliath-mornin-delight/151817/')
beerData = beerParser.parseLocations('http://www.ratebeer.com/breweries/')
